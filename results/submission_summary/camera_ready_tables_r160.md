# Camera-Ready Tables (R160 Snapshot)

## Snapshot Rule

- Target round is set to 160.
- For each method run, we use the latest available mechanism checkpoint with `round <= 160`.
- Current sources are:
  - Full: `cifar10_FedUgV2_0.5_full_topsec200` at round 155
  - NoFSA: `cifar10_FedUgV2_0.5_nofsa_topsec200` at round 155
  - NoGC: `cifar10_FedUgV2_0.5_nogc_topsec_gpu` at round 15

## Table 1 (RQ1/RQ2): Mechanism and Reliability (R160 Rule)
...
## Table 2 (RQ4): Byzantine Robustness (Latest <=160)
